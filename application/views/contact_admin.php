...
<div class="block">
   <!-- start of header -->
   <table width="100%" bgcolor="white" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header">
      <tbody>
         <tr>
            <td>
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td>
                           <table width="540" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidthinner">
                              <tbody>
                                 ...
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: black; text-align:left;line-height: 24px;" st-content="rightimage-paragraph">
                                      We have a new student Contact Details.<br></br><br></br>
                                    </td>
                                 </tr>
                       ...
                       <tr>
                         ...
                         <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; line-height: 20px;" st-title="fulltext-title"  width="37%"><?php echo $result[0]['phone_num'] ;?></br></br></td>
                        
                       </tr>
                      <tr>
                         <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; line-height: 20px;" st-title="fulltext-title"  width="37%">Company</br></br></td>
                         <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; line-height: 20px;" st-title="fulltext-title"  width="37%"><?php echo $result[0]['company'] ;?></br></br></td>
                     </tr>
                     <tr>
                         <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; line-height: 20px;" st-title="fulltext-title"  width="37%">Message</br></br></td>
                         <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; line-height: 20px;" st-title="fulltext-title"  width="37%"><?php echo $result[0]['message'] ;?></br></br></td>
                     </tr>                      
                     </table>
                                 </tr>
                           </table>
