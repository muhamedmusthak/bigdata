...
<div id="content" class="site-content">
 ...
 url('<?php echo base_url();?>application/images/about/ab3.jpg');   background-repeat:no-repeat; background-size:cover;">
        ...
        <ul class="bread-crumbs font-lato">
          ...
          <li href="#">BI and Data Warehouse</li>
        </ul>
  ...
  <!--   <div id="tabs">
    ...
    <div id="a_company" class="content-about-us">
        <div id="trusted-brands" class="bg-white" >
            <div class="row">
                <div class="title" >
                <a type="button" class="course-button" style="float: left;" href="network_mining">Previous</a> <a type="button" class="course-button" style="float: right" href="cognitive">Next</a>
                <h2 style="padding-top: 80px;" align="center">BI and Data Warehouse</h2>

                <h3 style="padding-bottom: 20px;">Comparative Performance Evaluation For Partners, POS &amp; Field Staff</h3>
                <div>
                <h6 >Client Organization</h6>
                	<p class="col-md-offset-1">India's largest private steel company, Kolkata.</p>
                </div>
                <div style="padding-bottom: 20px;">
                	 <h6>Project Owner</h6>
                	<p class="col-md-offset-1"><strong style="color: #31B0D5">CMO</strong></p>
                	<div id="img">
                	<img src="<?php echo base_url();?>application/images/courses/bi.png">
                	</div>
                </div>
                <div>
                	<h6>The Problem</h6>
                	<p class="col-md-offset-1">The Company sells branded steel bars and plates through physical channels having distributors, dealers and end-customers. &nbsp; The performance of a dealer depends on hundreds of factors, and is usually only understood approximately. &nbsp; Data also is highly fragmented and duplicated within the company. &nbsp; The client wanted to rate their dealers more accurately.</p>
                </div>
                <div>
                	<h6>The Solution</h6>
                	<p class="col-md-offset-1">We built a unified, de-normalized data store and then constructed complex predictive models on it to precisely rate dealers in terms of volume, creditworthiness, differentiation, etc. &nbsp; We developed an interactive dashboard using only open-source tools to allow our client and their distributors to rate, compare, analyze and track dealer performance in near real time.</p>
                   
                </div>
                <div>
                   	<h6>Tools &amp; Technologies</h6>
                	<p class="col-md-offset-1">Cassandra, SQL scripting, R, Python.</p>
                </div>
                </div>
            </div>
          </div>
