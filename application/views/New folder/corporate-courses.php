...
<style>
    ...
    <li class="one-fourth card-items mix item-advanced" style="display: flex;">
    <a href="<?php echo base_url('BigdatasiteController/corporate_training');?>" class="course-foundation item-484 bg-grey1">
        <div class="card-image" style="padding-bottom: 0px;">
                    <div style="background: transparent url('<?php echo base_url()?>application/images/courses/ct.jpg') no-repeat scroll bottom 30px center / 100% 100%; height: 142px;" class="wp-review-thumbnail-wrapper"></div>
        ...
        <div class="card-content-new">
            <div class="card-content-in-new">
                ...
                <h6 style="height:20px;color:">Topics</h6>
              <p>Big Data Analytics using R and Hadoop.</p>
                  <div class="card-date" style="padding-right: 15px;">
                        <!-- <span style="padding-right: 20px;">
                          <i class="fa fa-clock-o" aria-hidden="true" style="color:#999999;"></i>
