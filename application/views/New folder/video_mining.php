...
<div id="content" class="site-content">
 ...
 url('<?php echo base_url();?>application/images/about/ab3.jpg');   background-repeat:no-repeat; background-size:cover;">
        ...
        <ul class="bread-crumbs font-lato">
          ...
          <li href="#">Image, Audio and Video Mining</li>
        </ul>
  ...
  <!--   <div id="tabs">
    ...
    <div id="a_company" class="content-about-us">
        <div id="trusted-brands" class="bg-white" >
            <div class="row">
                <div class="title" >
               <!--  <a type="button" class="btn btn-info" style="float: left;" href="banking">Previous</a> --> <a type="button" class="course-button" style="float: right" href="bigdata_solution">Next</a>
                <h2 style="padding-top: 80px;" align="center">Image, Audio and Video Mining</h2>

                <h3 style="padding-bottom: 20px;">Text &amp; Media Analytics For Profiling Potential Customers</h3>
                <div>
                <h6 >Client Organization</h6>
                	<p class="col-md-offset-1">One of India's top-5 financial services company, Mumbai.</p>
                </div>
                <div style="padding-bottom: 20px;">
                	 <h6>Project Owner</h6>
                	<p class="col-md-offset-1"><strong style="color: #31B0D5">Head Of Institutional Equity</strong></p>
                	<div id="img">
                	<img src="<?php echo base_url();?>application/images/courses/image.png" width="500px;" >
                	</div>
                </div>
                <div>
                	<h6>The Problem</h6>
                	<p class="col-md-offset-1">Relationship managers within our client’s organization wanted to find up-to-date information about current and potential customers using data they shared on one or more web-based social networks.</p>
                </div>
                <div>
                	<h6>The Solution</h6>
                	<p class="col-md-offset-1">Quadratyx is building a Big Data stack along with customized web-crawlers, containing preprocessing and natural language processing layers implemented to filter out all unnecessary information from the collected data.</p>
                </div>
                <div>
                   	<h6>Tools &amp; Technologies</h6>
                	<p class="col-md-offset-1">Complete Cloudera Hadoop stack plus Nutch, Solr, R and Stanford NLP software.</p>
                </div>
                </div>
            </div>
          </div>
