  ...
  <!--   <div id="tabs">
    ...
    <div id="a_company" class="content-about-us">
        <div id="trusted-brands" class="bg-white" >
            <div class="row">
                <div class="title" >
                 <a type="button" class="course-button" style="float: left;" href="agriculture">Previous</a> 
                <!--  <a type="button" class="course-button" style="float: right" href="education">Next</a> -->
                 <h2 style="padding-top: 80px;" align="center">Oli , Gas And Energy</h2>
                 <h3 style="padding-bottom: 20px;">Getting More Out Of 360-Degree Reviews</h3>
                    <div>
                     ...
                     <div>
                         <h6>The Problem</h6>
                         <p class="col-md-offset-1">The business firm conducted 360-degree feedback annually to understand and evaluate the performance of the employees. &nbsp; The feedback was usually a hard copy of the electronically available review form manually filled by the employees or was sometimes filled online. In either case, much of the information was in unstructured form (text). &nbsp; The manager performed their evaluation of performance intuitively. &nbsp; This process was cumbersome, and comparative insights were seldom used. &nbsp; The client wanted to draw insights from the data and setup an infrastructure they would be able to collate and use their data in the future. </p>
                     </div>
                     <div>
                         <h6>The Solution</h6>
                         <p class="col-md-offset-1">We collected data from multiple 360-degree review feedback reports (PDFs), performed data loading, designed a multi-dimensional model and loaded the data into a SQL database. &nbsp; For descriptive analysis, we designed an interactive dashboard that summarizes the information, and provides drill-down and roll-up operations to get insights from the data. &nbsp; The analysis was done across five different dimensions: people who reviewed it, people who were being reviewed, features of review, scoring and textual comments. &nbsp; To analyze textual comments, we applied text analytics. &nbsp; For predictive analytics, models were built to find clusters of different features along which all managers had similar feedbacks. &nbsp; These clusters indicated that the features were either not distinctive or that reviewers really did not comprehend the subtleties of the features. &nbsp; We linked the online review form and connected the database to our recently designed interactive dashboard with built in analytical models for future use.</p>
                     </div>
                     <div>
