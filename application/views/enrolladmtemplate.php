                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #95a5a6; text-align:left;line-height: 24px;" st-content="rightimage-paragraph">
                                      We have a new student registration for <?php echo $course;?> course.<br></br><br></br>
                                    </td>
                                 </tr>
                                 
                                  <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; line-height: 20px;" st-title="fulltext-title">
                                       Student Name - <?php echo $firstname;?></br></br>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px;  line-height: 20px;" st-title="fulltext-title">
                                ...
                                <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px;  line-height: 20px;" st-title="fulltext-title">
                                       Contact No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - <?php echo $phonenum;?></br></br>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px;  line-height: 20px;" st-title="fulltext-title">
                                 ...
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; line-height: 20px;" st-title="fulltext-title">
                                      Batch &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - <?php echo $batch;?></br></br>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; line-height: 20px;" st-title="fulltext-title">
                                      Batch Timing &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - <?php echo $batch_timing;?></br></br>
                                    </td>
                                 </tr>
                                 <!-- <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px;  line-height: 20px;" st-title="fulltext-title">
                                       You have been enrolled, Now you can login your account.
                                    </td>
                                 </tr> -->
