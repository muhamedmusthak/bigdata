            ...
            <td>
               <table bgcolor="#ffffff" width="580" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth" modulebg="edit">
                  <tbody>
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #95a5a6; text-align:left;line-height: 24px;" st-content="rightimage-paragraph">
                                      We have a new student registration for <?php echo $result[0]['course_name'] ;?> course.<br></br><br></br>
                                    </td>
                                 </tr>
                     ...
                     <tr>
                         <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; line-height: 20px;" st-title="fulltext-title"  width="37%">Course</br></br></td>
                         <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; line-height: 20px;" st-title="fulltext-title"  width="37%"><?php echo $result[0]['course_name'] ;?></br></br></td>
                     </tr>                      
                     </table>
                                 </tr>
