            ...
            <td>
               <table bgcolor="#ffffff" width="580" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth" modulebg="edit">
                        ...
                        <td>
                           <table width="540" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidthinner">
                              <tbody>
                                 ...
                                 <!-- title -->
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #333333; text-align:left;line-height: 20px;padding-left:50px" st-title="rightimage-title">
                                      Hi <?php echo $result[0]['first_name']; ?> ,<br></br>
                                    </td>
                                 </tr>
                                 <!-- end of title -->
                                 <!-- Spacing -->
                                 ...
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #95a5a6; text-align:left;line-height: 24px;padding-left:50px" st-content="rightimage-paragraph">
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td>
                           <table class="table-responsive tablein" style="margin-left:150px;margin-top:20px">
                             <tbody>
                              <tr>
                           <!--       <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #333333; text-align:left;line-height: 20px;" st-title="rightimage-title">
                                       Hi <?php echo $result[0]['first_name']; ?> ,<br>
                                    </td> -->
                              <tr>
                                 <td>Email: </td>
                               ...
                               <tr>
                                ...
                                <tr>
                                 <td>Address : </td>
                                 <td colspan="3"><?php echo $result[0]['address']; ?></td>
                               </tr><br><br>
                               <?php if(isset($result[0]['ready_to'])){ ?>
                               <tr>
                                 <td>work experience: </td>
                                 <td colspan="3"><?php echo $result[0]['work_exp']; ?></td>
                               </tr><br></br>
                               <tr>
                                 <td>Educational Qualification: </td>
                                 <td colspan="3"><?php echo $result[0]['educational_type']; ?></td>
                               </tr><br></br>
                               <tr>
                                 <td>Specialization : </td>
                                 <td colspan="3"><?php echo $result[0]['education_name']; ?></td>
                               </tr>
                               <tr>
                                 <td>Preferred schedule for the course : </td>
                                 <td colspan="3"><?php echo $result[0]['preferred_course']; ?></td>
                               </tr>
                               <br></br>
                              <?php } ?>
                              </tbody>
