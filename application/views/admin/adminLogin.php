	...
	<div id="page-container" class="fade">
        ...
        <div class="login login-v2" data-pageload-addclass="animated flipInX">
            ...
            <div class="login-header">
                <div class="brand">
                    <img src="<?php echo base_url();?>application/assets/img/bigdata-logo.png" data-id="login-cover-image" alt="" />
                    <!-- <span class="logo"></span> BDIH -->
            ...
            <div class="login-content">
                <form action="<?php echo base_url('bigdataAdminController/login_auth');?>" method="POST" class="margin-bottom-0">
