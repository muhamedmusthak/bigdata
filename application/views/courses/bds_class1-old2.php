            ...
            <div style="padding-left: 0px!important;">
              ...
              ?>
                <h4 class="font-lato" style="font-size: 14px;"><?php echo $daytiming[0]['day']?></h4>
                  ...
                  <p style="color:#15549A;;padding-bottom:10px;">Cost &nbsp;: &nbsp;<?php echo $result[0]['class_fees']?></p>
            </div>       
         </div>
   	...
   	<div class="enroll-form col-md-4 col-sm-5">
   		<div class="enroll-in-form">
   			<div class="batch_timing">
		          ...
		          ?>
		          <h4 class="font-lato" style="font-size: 16px;"><i class="fa fa-calendar" aria-hidden="true" style="color:#15549A;"></i>&nbsp <span style="color:#15549A;">Batch Filled- <?php echo $predate=date('d-M-Y',strtotime($predate));?> </span></h4>
		          <h4 class="font-lato" style="font-size: 16px;color:#15549A;text-align:center">Next Batch Starts On - <?php echo $val2;?></h4>
		          <?php } else { 
		            ?>
		          <h4 class="font-lato" style="font-size: 16px;"><i class="fa fa-calendar" aria-hidden="true" style="color:#15549A;"></i>&nbsp <span style="color:#15549A">Batch Statrs on- <?php echo $val2;?> </span>
		          </h4><p></p>
		          <?php } ?>
   			</div>
