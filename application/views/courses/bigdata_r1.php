...
<div id="content" class="site-content">
  <div class="row fullform">
    <div class="col-md-3 col-sm-5 col-md-offset-2" style="margin-bottom: 10px;">
      <div class="inner-border">

        <img class="img" src="<?php echo base_url();?>application/images/courses/coursesbg.png">
        <p class="p1">Big Data and Data Science with R</p>
        <div class="duration">
    ...
    <div class="enroll-form col-md-4 col-sm-5">
      <div class="enroll-in-form">
        <div class="batch_timing">
          ...
          <h4 class="font-lato" style="font-size: 16px;color:green;text-align:center;font-weight: 600;">Available Batch Starts On <br><i class="fa fa-calendar" aria-hidden="true" style="color:green;"></i>&nbsp <span style="color:green">
