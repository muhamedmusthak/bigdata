                        ...
                        <td>
                           <table width="540" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidthinner">
                              <tbody>
                                 ...
                                 <!-- title -->
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #333333; text-align:left;line-height: 20px;" st-title="rightimage-title"><!-- <?php print_r($result[0]['first_name']);?> -->
                                       Hi <?php echo $result[0]['first_name']; ?> ,
                                    </td>
                                 </tr>
                                 <!-- end of title -->
                                 <!-- Spacing -->
                                 ...
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #95a5a6; text-align:left;line-height: 24px;" st-content="rightimage-paragraph">
                                       Sorry ! you haven't cleared the online assessment, kindly contact the admin for the further step.
                                       <br></br><br></br>
                                    </td>
                                 </tr>
                                  <tr>
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #333333; text-align:center;line-height: 20px;" st-title="fulltext-title">
                                        <a style="color: #ffffff; text-align:center;text-decoration: none;" href="#">Click here to proceed payment</a>
                                    </td>
                                 </tr>
                                 <!-- End of Title -->
                                 <!-- spacing -->
