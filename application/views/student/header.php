...
$name=$sessiondata['name']; $email=$sessiondata['email']; $role=$sessiondata['role']; ?>
<!DOCTYPE html>
		...
		<div id="sidebar" class="sidebar">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li class="has-sub">
						<a href="<?php echo base_url('BigdataAdminController/student_dashboard');?>">
					...
					<li class="has-sub">
						<a href="<?php echo base_url('BigdataAdminController/student_profile');?>">
						   <!--  <b class="caret pull-right"></b> -->
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
							<li><a href="<?php echo base_url('BigdataAdminController/duration');?>">Duration</a></li>
						<li><a href="<?php echo base_url('BigdataAdminController/syallabus');?>" >Syallabus</a></li>
						    <li><a href="#">Course material download</a></li>
						</ul>
					</li>
