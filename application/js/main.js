...
//funciton for training on demand page
...
//alert(last_name);
            ...
            var edu_qualification=$(".getvalue").val();
 ...
 {  
     ...
     $("input[name='education_qua']").click(function()
     {
        ...
        if(con=="ug")
        {
          console.log(con);
          $(".pg").hide();
          $(".ug").addClass("getvalue");
          $(".ug").show();
        }
        else
        {
          console.log(con);
          $(".pg").addClass("getvalue");
          $(".pg").show();
          $(".ug").hide();
        }
  ...
  // contact us 
    ...
    $("#contactform").submit(function(e){
          ...
          $.ajax({
           type:"post",
           //url:"<?php echo base_url() ?>" + "BigdatasiteController/get_batchtiming",
           url: base_url+ "BigdatasiteController/register_contact",
          
           data:{salutation:salutation,first_name:first_name,last_name:last_name,contact:contact,company:company,email:email,message:message},
           success :function(response)
           {
              // loading.hide();
              $(".loader").addClass("hide");
