  ...
  $(".thankyoumes").hide();
    ...
    $('#contact_form').bootstrapValidator({
        fields: {
            ...
            //alert(preferred_course); 
          
            $.ajax({
               type:"post",
               //url:"<?php echo base_url() ?>" + "BigdataAdminController/enrollvalue",
               url: base_url+"BigdataAdminController/enrollvalue",
               data:{preferred_course:preferred_course,salutation:salutation,first_name:first_name,last_name:last_name,email:email,contact:contact,address:address,course_id:course_id,edu_qualification:edu_qualification,work_exp:work_exp,read_to_start:read_to_start,contact_me:contact_me},
               dataType:'json',
