...
class BigdataAdminController extends CI_Controller 
{
    ...
    function detailform()
    {
		...
		$data['result'][0]['last_name'] = $result2[0]['last_name'];
                //print_r($data['result'][0]['last_name']); exit();
	    ...
	    $this->email->from('musthakcse@gmail.com','BDIHUB Administrator'); // change it to yours
		...
		$this->email->set_mailtype("html");
	    $this->email->set_newline("\r\n");
	    $this->email->from('musthakcse@gmail.com','BDIHUB'); // change it to yours

	    $this->email->to('musthakcse@gmail.com');

	    //$this->email->to('abdulsbk20@gmail.com');
 ...
 function detailform_trainingcourse()
    	...
    	if($result2[0]['session_id']=='3')
    	{
           ...
           'smtp_auth'=> TRUE
		    ...
		    //$this->email->to('jayawebdeveloper@gmail.com');
                    $this->email->to('musthakcse@gmail.com');
		    //$this->email->cc("Priscilla.william@bdihub.com");
		    //$this->email->cc("lauro.bianda@bdihub.com");
		    $this->email->subject('New student registered');
  ...
  //   	// print_r($this->input->post('firstname')); exit();
  //   	// $data['first_name']=$this->session->userdata['sessiondata']['first_name'];
		// //print_r($this->input->post('batch')); exit();   
		// //print_r($data['batch']); 
		// //print_r($data['first_name'],"first_name");     
		// // exit();
	 //    //$first_name=$whole.first_name;
	 //   // $data['last_name']=$this->session->userdata['sessiondata']['last_name'];
	 //   // $data['salutation']=$this->session->userdata['sessiondata']['salutation'];
	 //   // $data['email']=$this->session->userdata['sessiondata']['email'];
	 //   // $data['phone_num']=$this->session->userdata['sessiondata']['phone_num'];
	 //   // $data['company']=$this->session->userdata['sessiondata']['company'];
	 //   // $data['course']=$this->session->userdata['sessiondata']['course'];
	 //    $this->load->view('includes/header');
		// $this->load->view('payment_details', $data);
 ...
 function paymentlater()
   {
    	...
    	if($result2[0]['session_id']=='3')
    	{
           ...
           'smtp_auth'=> TRUE
			...
			$this->email->set_mailtype("html");
		    $this->email->set_newline("\r\n");
		    $this->email->from('musthakcse@gmail.com','payment BDIHUB Administrator'); // change it to yours
		    $this->email->to($data['result'][0]['email']);
		    $this->email->subject('You have successfully registered for course.');
	        $message=$this->load->view('paymentlater',$data,TRUE);
		    $this->email->message($message);
     ...
     //print_r($email);exit();
	   ...
	   //   if($this->email->send())
			 ...
			 //     else{
				// 	echo 'Mail Not Sent';
				// }
    	// $result=$this->BigdataAdminModel->emailSend();
    }
	 ...
	 function success_payment()
  {
	...
	//{
		...
		//{
			...
			//$data['enroll_count']=$this->BigdataAdminModel->count_enroll_students();
			//$data['reg_count']=$this->BigdataAdminModel->count_reg_students();
			//$data['users_count']=$this->BigdataAdminModel->count_bdihub_users();
			//$this->load->view('admin/header');
	...
	function addquestions(){
		...
		//print_r($data['courseName']['course_id']);	exit();
