...
class BigdatasiteController extends CI_Controller {
	...
	{
		 //        $result['data']=$this->BigdatasiteModel->get_pathfinder_details();
			// $result['value']=$this->BigdatasiteModel->get_pathfinder_course();
            $data['result1']=$this->BigdatasiteModel->get_r_course_details();
      //       $data['result1']=$this->BigdatasiteModel->get_bigdata_details();
   			// $data['result2']=$this->BigdatasiteModel->get_datascience_details();
	   ...
	   function thankyou_payment(){
		...
		$data1 = $this->BigdatasiteModel->payment_update($referenceCode);
...
function insert_training(){
	...
	$config = Array(
	     ...
	     $this->email->from('musthakcse@gmail.com','Administrator'); // change it to yours
	...
	{	
		$this->BigdatasiteModel->insert_batch_other();
         ...
         function training_student(){
		$this->view->training_student();
	}
	 function training_admin(){
		$this->view->training_admin();
	}
...
?> 
             ...
             <!--   <div class="tab-pane fade" style="padding-bottom: 40px;padding-top: 40px;" id="scheduler1">
              ...
              <div class="row" style="padding-top: 10px;padding-bottom:10px;pading-left:10%;">                
               ...
               <div class="row" style="padding-bottom:10px;pading-left:10px;"> 
                <div class="col-md-6">
                 <label>Weakdays</label><br>
               <input type="checkbox"> Saturday and Sunday<br>     
                </div> 
                 <div class="col-md-6">
                 <label> Batch Timing</label><br>
               <input class='q3_option' name='q10_option' type='radio'/> Morning  9 am to Evening 6 pm <br>    
                </div>            
              </div>
   ...
   function global_opportunities_new()
	...
	// function how_it_works_training()
	// {

	// 	$this->load->view('includes/header');
	// 	$this->load->view('includes/how-it-works-training');
	// 	$this->load->view('includes/footer');
 ...
 //                 }
	// 	else{
	// 	$this->load->view('header');
	// 	$this->load->view('corporate-solution');
	// 	$this->load->view('footer');
 //                }
	// }
